...
```{r Question 2}
1. "The impact of social media marketing on consumer behavior" by Angel Papet Favret and Salah
Elatroush
https://lnu.diva-portal.org/smash/get/diva2%3A1865305/FULLTEXT01.pdf

The explores the impact of social media marketing on consumer behavior, and finds that social media marketing significantly influences consumer behavior both positively and negatively. Positive effects include increased brand discovery, emotional engagement, and the influence of promotions or discounts on purchase decisions. However, negative effects such as overexposure, unrealistic beauty standards, and emotional impacts on mental health were also noted. Consumers were found to engage with marketing content that evoked emotional responses, with video-based advertisements being the most persuasive. Many respondents expressed a reliance on user-generated reviews rather than brand-promoted content. It shows this through publically accessible data.

  
2. "Machine learning-based mathematical modelling for prediction of social media consumer behavior using big data analytics" by Kiran Chaudhary, Mansaf Alam, Mabrook S. Al-Rakhami & Abdu Gumaei  
https://journalofbigdata.springeropen.com/articles/10.1186/s40537-021-00466-2#Tab3

The study focuses on predicting consumer behavior influenced by social media advertising through machine learning and big data analytics. It utilizes publically accessible data collected from platforms like Facebook, Twitter, Instagram, LinkedIn, Pinterest, and YouTube.The analysis highlighted that social media platforms significantly influence consumer behavior, with notable variations in engagement metrics such as likes, follows, and visits.The findings have practical implications for businesses, enabling them to predict consumer preferences, optimize social media strategies, and foster better engagement with target audiences.
```
